                ...
                <div class="card-body p-md-5">
                  ...
                  @endif
                        ...
                        <div class="form-check d-flex justify-content-center mb-5">
                          <input class="form-check-input me-2" type="checkbox" aria-describedby="clickableCheckbox"id="myCheckbox" required/>
                          <label class="form-check-label" for="myCheckbox">
                           <span id="clickableCheckbox">I agree all statements in</span>  
